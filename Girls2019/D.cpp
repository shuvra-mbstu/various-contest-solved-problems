...
______\///___\/\\\_______\/\\\__\/\\\_______\/\\\__\//\\\______/\\\___\/\\\_____\/\\\_____/\\\/////////\\\_
...
int num1,val,arr[100005],coun=0,way=0,mx,x,y;
string st;
vector<int> vt;
int main()
{
...
//cout<<vt[i+val]<<endl;
            ...
            //    cout<<mx<<" dgh "<<way<<endl;

        }
    }
    if(sz==0)mx=num1,way=1;
