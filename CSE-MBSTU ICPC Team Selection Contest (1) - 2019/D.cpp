...
int num, small, large, sum;
double x;
cin>>num>>small>>large>>sum;
if(num==1 ){
     if(small==large && small ==sum)cout<<"YES\n";
     else cout<<"NO\n";
     return 0;
}
else if(num==2){
     if(sum==(small+large))cout<<"YES\n";
     else cout<<"NO\n";
     return 0;
}
sum=sum-(small+large);
//cout<<sum<<endl;
x=(double)sum/(double)(num-2);
//cout<<x<<endl;
if(x>=small && x<=large)cout<<"YES\n";
else cout<<"NO\n";
}
