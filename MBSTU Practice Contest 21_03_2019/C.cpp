...
if(a== b){
    ...
    int x=fun(x1,y1,0,num);
    int y=fun(x2,y2,0,num);
    val=x+y;
}
...
else
{
    ...
    val=min(xx,yy);
      ...
      //  cout<<"FSDTHT  "<<a<<" "<<b<<endl;
    int x=fun(x1,y1,num,0);
    int y=fun(x2,y2,num,0);
    val=x+y;
}
...
else
{
    ...
    int x=fun(x1,y1,num,num);
    int y=fun(x2,y2,num,num);
    val=x+y;
}
cout<<val<<endl;
}
