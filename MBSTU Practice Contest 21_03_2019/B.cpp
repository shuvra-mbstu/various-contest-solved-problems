...
#define Mx 200007
ll arr[Mx],sum[3*Mx],num;

void seg_build(ll aat,ll l, ll r){
...
ll mid=(l+r)/2;
seg_build(aat*2,l,mid);
seg_build(aat*2+1,mid+1,r);
sum[aat]=min(sum[aat*2],sum[aat*2+1]);
return;
