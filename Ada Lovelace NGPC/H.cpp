...
#define Mx 90000000000
   long long int num,query,ar1[27],ar2[27],sum,x1=0,x2=0,coun=0,m1=Mx,m2=Mx;
   long long int fun(int ind1, int ind2, long long int val1,long long int val2){
        coun ++;
      //  cout<<ind1<<" "<<ind2<<" "<<val1<<" "<<val2<<" "<<coun<<endl;
        if(val1==val2)return 0;

         long long int v1=Mx,v2=Mx,v3=Mx;

     if(ind1+1<=num){
   v1=fun(ind1+1,ind2,val1-ar1[ind1],val2)+1;
   long long int vv =fun(ind1+1,ind2,val1,val2);
   v1=min(v1,vv);
     }
         if(ind2+1<=num){
    v2=fun(ind1,ind2+1,val1,val2-ar2[ind2])+1;
    long long int vx=fun(ind1,ind2+1,val1,val2);
    v2=min(v2,vx);
         }
     return min(v1,v2);
    }
