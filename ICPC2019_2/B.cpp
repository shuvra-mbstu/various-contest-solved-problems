    ...
    FOR(i,0,test)
    {
        ...
        else
        {
            ...
            FOR(j,0,len1)
            {
                if(ss[i]=='p' ||ss[i]=='P')
                {
                    if(!(st[i]=='p'||st[i]=='P'||st[i]=='b'||st[i]=='B'))
                    {
                        cout<<"No\n";
                        x=1;
                    }
                }
                else if(ss[i]=='B' ||ss[i]=='b')
                {
                    if(!(st[i]=='p'||st[i]=='P'||st[i]=='b'||st[i]=='B'))
                    {
                        cout<<"No\n";
                ...
                else   if(ss[i]=='i' ||ss[i]=='I')
                {
                    if(!(st[i]=='i'||st[i]=='I'||st[i]=='E'||st[i]=='e'))
                    {
                        cout<<"No\n";
                        x=1;
                    }
                ...
                {
                    if((st[i]>='A' &&st[i]<='Z')&&(ss[i]>='a' && ss[i]<='z' )&& ((st[i]-'A')==(ss[i]-'a')))
                    {
                        cout<<"Yes\n";
                        x=1;
                    }
                    else if((st[i]>='a' &&st[i]<='z')&&(ss[i]>='A' && ss[i]<='Z') && ((st[i]-'a')==(ss[i]-'A')))
                    {
                        cout<<"Yes\n";
                        x=1;
                    }
